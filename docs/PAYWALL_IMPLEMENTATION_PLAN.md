...
| タスク   | 内容                                                                   | 完了 |
| -------- | ---------------------------------------------------------------------- | ---- |
| タスク 1 | `pubspec.yaml` に依存関係追加                                          | [ ]  |
| タスク 2 | `lib/services/revenue_cat_service.dart` 作成（最小限の機能）           | [ ]  |
| タスク 3 | `main.dart` で RevenueCat 初期化                                       | [ ]  |
| タスク 4 | **動作確認**: アプリ起動時に RevenueCat が正常に初期化されることを確認 | [ ]  |

#### Step 1.2: 基本的なペイウォール画面 (1 日)

| タスク   | 内容                                                                       | 完了 |
| -------- | -------------------------------------------------------------------------- | ---- |
| タスク 1 | `lib/views/paywall_page.dart` 作成（シンプルな UI）                        | [ ]  |
| タスク 2 | `lib/constants/subscription_plans.dart` 作成                               | [ ]  |
| タスク 3 | メイン画面からペイウォール画面への遷移追加                                 | [ ]  |
| タスク 4 | **動作確認**: ペイウォール画面が表示され、プラン一覧が表示されることを確認 | [ ]  |

#### Step 1.3: 基本的な課金状態管理 (1 日)

| タスク   | 内容                                                       | 完了 |
| -------- | ---------------------------------------------------------- | ---- |
| タスク 1 | `lib/models/subscription_status.dart` 作成                 | [ ]  |
| タスク 2 | `lib/services/revenue_cat_service.dart` に状態管理機能追加 | [ ]  |
| タスク 3 | メイン画面で課金状態を表示                                 | [ ]  |
| タスク 4 | **動作確認**: 課金状態が正しく表示されることを確認         | [ ]  |

#### Step 1.4: オフライン対応の基本実装 (1 日)

| タスク   | 内容                                                            | 完了 |
| -------- | --------------------------------------------------------------- | ---- |
| タスク 1 | `lib/services/offline_subscription_manager.dart` 作成（最小限） | [ ]  |
| タスク 2 | ローカルストレージでの状態保存                                  | [ ]  |
| タスク 3 | **動作確認**: オフライン時でも課金状態が表示されることを確認    | [ ]  |
...
| タスク   | 内容                                                               | 完了 |
| -------- | ------------------------------------------------------------------ | ---- |
| タスク 1 | `lib/services/revenue_cat_service.dart` に購入機能追加             | [ ]  |
| タスク 2 | `lib/views/paywall_page.dart` に購入ボタン追加                     | [ ]  |
| タスク 3 | **動作確認**: 購入ボタンをタップして課金画面が表示されることを確認 | [ ]  |

#### Step 2.2: 無料トライアル機能 (2 日)

| タスク   | 内容                                                                 | 完了 |
| -------- | -------------------------------------------------------------------- | ---- |
| タスク 1 | `lib/services/revenue_cat_service.dart` にトライアル機能追加         | [ ]  |
| タスク 2 | トライアル開始・終了の処理                                           | [ ]  |
| タスク 3 | **動作確認**: トライアル開始後、プレミアム機能が利用できることを確認 | [ ]  |

#### Step 2.3: 購入復元機能 (1 日)

| タスク   | 内容                                                       | 完了 |
| -------- | ---------------------------------------------------------- | ---- |
| タスク 1 | `lib/services/revenue_cat_service.dart` に復元機能追加     | [ ]  |
| タスク 2 | ペイウォール画面に復元ボタン追加                           | [ ]  |
| タスク 3 | **動作確認**: 復元ボタンで過去の購入が復元されることを確認 | [ ]  |

#### Step 2.4: 広告削除機能の統合 (2 日)

| タスク   | 内容                                                   | 完了 |
| -------- | ------------------------------------------------------ | ---- |
| タスク 1 | 既存の広告表示ロジックを修正                           | [ ]  |
| タスク 2 | 課金状態に応じた広告表示制御                           | [ ]  |
| タスク 3 | **動作確認**: 課金後、広告が表示されなくなることを確認 | [ ]  |
...
| タスク   | 内容                                                     | 完了 |
| -------- | -------------------------------------------------------- | ---- |
| タスク 1 | `lib/services/revenue_cat_ab_test_service.dart` 作成     | [ ]  |
| タスク 2 | ペイウォール画面に A/B テスト機能統合                    | [ ]  |
| タスク 3 | **動作確認**: 異なるバリエーションが表示されることを確認 | [ ]  |

#### Step 3.2: 通知機能 (2 日)

| タスク   | 内容                                           | 完了 |
| -------- | ---------------------------------------------- | ---- |
| タスク 1 | `lib/services/notification_service.dart` 作成  | [ ]  |
| タスク 2 | トライアル終了リマインダー                     | [ ]  |
| タスク 3 | **動作確認**: 通知が正しく送信されることを確認 | [ ]  |

#### Step 3.3: オフライン機能強化 (2 日)

| タスク   | 内容                                                        | 完了 |
| -------- | ----------------------------------------------------------- | ---- |
| タスク 1 | `lib/services/offline_subscription_manager.dart` 機能拡張   | [ ]  |
| タスク 2 | ネットワーク復帰時の同期機能                                | [ ]  |
| タスク 3 | **動作確認**: オフライン → オンライン復帰時の状態同期を確認 | [ ]  |

#### Step 3.4: UI/UX 改善 (1 日)

| タスク   | 内容                                                              | 完了 |
| -------- | ----------------------------------------------------------------- | ---- |
| タスク 1 | ペイウォール画面のデザイン改善                                    | [ ]  |
| タスク 2 | ローディング状態の追加                                            | [ ]  |
| タスク 3 | エラーハンドリングの改善                                          | [ ]  |
| タスク 4 | **動作確認**: UI が改善され、エラー処理が適切に動作することを確認 | [ ]  |
